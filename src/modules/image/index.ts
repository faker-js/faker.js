...
export class ImageModule extends ModuleBase {
  ...
  /**
   * Generates a random square portrait of a person (avatar). These are currently images of fake people which were generated by an AI, Stable Diffusion 3. The image URLs are served via the JSDelivr CDN and subject to their [terms of use](https://www.jsdelivr.com/terms).
   *
